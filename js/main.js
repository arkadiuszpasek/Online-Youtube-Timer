...
let interval;
let minutes, seconds;
const defaultTitle = 'Youtube Timer';
const timer = document.getElementById('timer-txt');
const endAudio = new Audio('https://raw.githubusercontent.com/arkadiuszpasek/Online-Youtube-Timer/master/res/w3QuestSound.mp3');
